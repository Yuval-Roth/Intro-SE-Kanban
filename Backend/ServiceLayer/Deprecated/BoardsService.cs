...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    public class BoardsService
    {
        ...
        public BoardsService(BusinessLayer.DataCenter userData)
        {
        ...
        //public string LimitColumn(string email, string boardTitle, int columnOrdinal, int limit)
        //{
        //    return "";
        //}
        //public string GetColumnLimit(string email, string boardTitle, int columnOrdinal)
        //{
        //    throw new NotImplementedException();
        //}

        //public string GetColumnName(string email, string boardTitle, int columnOrdinal)
        //{
        //    throw new NotImplementedException();
        //}

        //public string AddTask(string email, string boardTitle, string title, string description, DateTime dueDate)
        //{
        //    throw new NotImplementedException();
        //}
        //public string AdvanceTask(string email, string boardTitle, int columnOrdinal, int taskId)
        //{
        //    throw new NotImplementedException();
        //}
        //public string GetColumn(string email, string boardTitle, int columnOrdinal)
        //{
        //    throw new NotImplementedException();
        //}
